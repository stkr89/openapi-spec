...
--------------|-----------------------------------------------------------|---------------------------|--------------------
 *DefaultApi* | [**ModelV1Get**](docs/DefaultApi.md#modelv1get)           | **Get** /model/v1         | List all models    
 *DefaultApi* | [**ModelV1IdDelete**](docs/DefaultApi.md#modelv1iddelete) | **Delete** /model/v1/{id} | Delete a model     
 *DefaultApi* | [**ModelV1IdGet**](docs/DefaultApi.md#modelv1idget)       | **Get** /model/v1/{id}    | Query a model      
 *DefaultApi* | [**ModelV1IdPut**](docs/DefaultApi.md#modelv1idput)       | **Put** /model/v1/{id}    | Update a model     
 *DefaultApi* | [**ModelV1Post**](docs/DefaultApi.md#modelv1post)         | **Post** /model/v1        | Create a new model 
